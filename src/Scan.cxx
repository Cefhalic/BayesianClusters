...
int main(int argc, char **argv)
{
  ...
  RunScan( lMasterConfig.inputFile() , AutoRoI() , lMasterConfig.configFile() , lMasterConfig.outputFile() );
}
...
// void ScanCallback( const RoIproxy& aRoI , const double& aR , const double& aT )
// {

// }

// void RoIcallback( RoI& aRoI , const ScanConfiguration& aScanConfig )
// {
//   aRoI.ScanRT( aScanConfig , &ScanCallback );
// }
...
// //   // AutoRoi_Scan_FullCallback( std::move( lInputFilename ) , lScanConfig , lCallback );

// //   // AutoRoi_Scan_FullCallback( std::move( lInputFilename ) , lScanConfig , &TestCallback );
...
// // void JsonCallback( const RoIproxy& aRoI , const double& aR , const double& aT , std::stringstream& aOutput, 
// //                   std::vector<std::vector<double>>& aRTScores, std::pair<int,int>& aMaxScorePosition, double& aMaxRTScore )
// // {
// //   mtx.lock();
...
// //   {
// //     std::cout << "Warning: Running scan without callback" << std::endl;
// //     aRoI.ScanRT( aScanConfig , [&]( const RoIproxy& aRoI , const double& aR , const double& aT){} ); // Null callback
// //     return;
// //   }
// //   // else if( lOutputFilename.size() > 4 and lOutputFilename.substr(lOutputFilename.size() - 4) == ".xml" )
// //   // {
...
// //   {
// //     std::stringstream lOutput;
// //     aRoI.ScanRT( aScanConfig , [&]( const RoIproxy& aRoI , const double& aR , const double& aT ){ JsonCallback( aRoI , aR , aT, lOutput, lRTScores, lMaxScorePosition, lMaxRTScore); } );
// //     std::ofstream lOutFile( aOutFile );
// //     lOutFile << "{\nResults:[\n" << lOutput.str() << "]\n}";
// //   }
// //   else
...
// void TestCallback( const RoIproxy& aRoI , const double& aR , const double& aT ){ 
//   sum += aRoI.mData.size();
// }

// // void RoIcallback( RoI& aRoI , const ScanConfiguration& aScanConfig ){
// //   aRoI.ScanRT( aScanConfig , &TestCallback );
// // }

// void RoIcallback( RoI& aRoI , const ScanConfiguration& aScanConfig ){
//   aRoI.ScanRT( aScanConfig , [&]( const RoIproxy& aRoI , const double& aR , const double& aT ){ TestCallback( aRoI , aR , aT ); } );
// }


// inline void LocalCopy_AutoRoi_Scan_FullCallback( const std::string& aInFile , const ScanConfiguration& aScanConfig, const std::function< void( RoIproxy&, const double&, const double& ) >& aCallback )
// {
